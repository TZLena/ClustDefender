...
def parse_args():
    ...
    parser.add_argument("--job_name", type=str, default="AdverItemNorm", help="name to choose job config including task, dataset, model etc..")
    parser.add_argument("--project_name", type=str, default="fl-attack", help="Wandb project name.")
    parser.add_argument("--run_name", type=str, default="no defense", help="Wandb run name.")
    ...
    #cluster
    parser.add_argument("--near_dist", type=float, default=2.2, help="threshold of distance that can be collected in near list")
    parser.add_argument("--eps", type=float, default=3.0, help="threshold of distance that can be clustered")
    parser.add_argument("--min_samples", type=int, default=5, help="threshold of samples number that can become a cluster")
